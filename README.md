...
«Allow new users to sign up»: кнопка «зарегистрироваться» выведена прямо в
интерфейс, и пока self-signup включён, аккаунт заводит любой посетитель.
Включать её обратно на минуту, когда понадобится ещё один аккаунт.
